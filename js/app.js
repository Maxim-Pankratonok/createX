(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".arrivals__slider")) new core(".arrivals__slider", {
            ...
            if (document.querySelector(".trending__slider")) new core(".trending__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".trending-arrow_prev",
                    nextEl: ".trending-arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.2,
        ...
        function windowLoad() {
            ...
            function documentActions(e) {
                ...
                if (targetElement.closest(".menu__link")) {
                    const menuLink = targetElement.closest(".menu__link");
                ...
                if (document.querySelector(".filter-catalog__button")) if (window.innerWidth < 992) document.querySelector(".filter-catalog__items").classList.toggle("_active");
            }
        }
        window["FLS"] = true;
        isWebp();
